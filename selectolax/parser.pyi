...
class Node:
    ...
    def find_all_next(self, name:str=None, attrs:dict=None, text:str=None, limit:int=None ) -> list["Node"]: ...
    def find_all_previous(self, name:str=None, attrs:dict=None, text:str=None, limit:int=None ) -> list["Node"]: ...
    def parents(self, name:str=None, attrs:dict=None, limit:int=None ) -> list["Node"]: ...
    def find_all_custom(self, query:str=None, text:str=None ) -> list["Node"]: ...
    @property
    def tag(self) -> str: ...
    @property
